...
import com.sajjadafridi58.adapters.PagerAdapterForFaisalAbad;
import com.sajjadafridi58.navigationappca.R;

/**
 * Created by Sajjad on 5/17/2016.
 */
public class FaisalabadActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.faisal_slider);// change
        actionBar = getSupportActionBar();
        actionBar.setDisplayOptions(ActionBar.DISPLAY_HOME_AS_UP |
                ActionBar.DISPLAY_SHOW_TITLE |
                ActionBar.DISPLAY_SHOW_CUSTOM |
                ActionBar.DISPLAY_SHOW_HOME);
        actionBar.setTitle("Faisal Abad");
...
// change
        adapter = new PagerAdapterForFaisalAbad(getSupportFragmentManager());
