...
import com.sajjadafridi58.adapters.PagerAdapterForLahore;
import com.sajjadafridi58.navigationappca.R;

/**
 * Created by Sajjad on 5/17/2016.
 */
public class LahoreActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lahore_slider);// change
        actionBar = getSupportActionBar();
        actionBar.setDisplayOptions(ActionBar.DISPLAY_HOME_AS_UP |
                ActionBar.DISPLAY_SHOW_TITLE |
                ActionBar.DISPLAY_SHOW_CUSTOM |
                ActionBar.DISPLAY_SHOW_HOME);
        actionBar.setTitle("Lahore");
...
// change
        adapter = new PagerAdapterForLahore(getSupportFragmentManager());
